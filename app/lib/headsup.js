...
Game.prototype.checkForEndOfRound = function () {
	...
	// bother playrs are allin or at at least one person folded
	if (getNumberOfPlayersInRoundAllIn(this) === 2 || 
		...
		(getNumberOfPlayersInRoundAllIn(this) === 1 && getNumberOfPlayersInRoundActed(this) !== 1)) {
...
function checkForEndOfBettingRound (game) {
	...
	if (game.checkForEndOfRound() === false) {
